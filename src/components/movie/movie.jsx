            ...
            <div className="movie-card__desc">
              ...
              <div className="movie-card__text">
                <p>In&nbsp;the 1930s, the Grand Budapest Hotel is&nbsp;a&nbsp;popular European ski resort, presided over by&nbsp;concierge
                  Gustave H. (Ralph Fiennes). Zero, a&nbsp;junior lobby boy, becomes Gustave&rsquo;s friend and protege.</p>

                <p>Gustave prides himself on&nbsp;providing first-class service to&nbsp;the hotel&rsquo;s guests, including satisfying the
                  sexual needs of&nbsp;the many elderly women who stay there. When one of&nbsp;Gustave&rsquo;s lovers dies mysteriously,
