            ...
            <div className="movie-card__desc">
              ...
              <div className="movie-card__reviews movie-card__row">
                <div className="movie-card__reviews-col">
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">Discerning travellers and Wes Anderson fans will luxuriate in&nbsp;the
                        glorious Mittel-European kitsch of&nbsp;one of&nbsp;the director&rsquo;s funniest and most exquisitely designed
                        movies in&nbsp;years.</p>
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">Anderson&rsquo;s films are too precious for some, but for those of&nbsp;us
                        willing to&nbsp;lose ourselves in&nbsp;them, they&rsquo;re a&nbsp;delight. &laquo;The Grand Budapest Hotel&raquo; is&nbsp;no
                  ...
                  <div className="review">
                    <blockquote className="review__quote">
                      <p className="review__text">I&nbsp;didn&rsquo;t find it&nbsp;amusing, and while&nbsp;I can appreciate the creativity,
                        it&rsquo;s an&nbsp;hour and 40&nbsp;minutes&nbsp;I wish&nbsp;I could take back.</p>
